...
> Historical note
> This file is a feature completion snapshot and still uses legacy path references such as `frontend/...` and `backend/...`. Treat it as historical implementation context rather than the authoritative current system description.
...
- **Status**: ✅ Complete
- **Location**: `apps/web/src/components/MapView.tsx`
- **Features**:
...
- **Status**: ✅ Complete
- **Location**: `apps/web/src/components/VesselDetails.tsx`
- **Features**:
...
- **Status**: ✅ Complete
- **Location**: `apps/web/src/components/AlertsPanel.tsx`
- **Features**:
