...
> Historical note
> This document contains legacy path examples and aspirational quality claims. For current repo-state validation, prefer `VALIDATION_REPORT.md` and the active code under `apps/api` and `apps/web`.
