...
> Historical note
> This file captures a pre-implementation gap analysis. Several items listed here were later implemented. Use it as historical context only, and cross-check against `FEATURES_IMPLEMENTED.md`, `SYSTEM_OVERVIEW.md`, and `VALIDATION_REPORT.md`.
