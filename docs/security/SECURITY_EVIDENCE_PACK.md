...
| Auditability              | A.8.15, A.8.16      | DE.AE, DE.CM       | CC7.2           | Audit coverage matrix + CI gate            | `docs/governance/AUDIT_COVERAGE_MATRIX.md`, `scripts/check_audit_coverage.py` | Security Engineering | Per PR         |
