...
Use `docs/funding/NATO_SUBMISSION_CLOSEOUT_CHECKLIST.md` as the canonical sequence for closing the remaining blockers between internal repo readiness and an externally defensible submission package.

Current blocking tracks:

- external receiver validation
- customer-side classified rehearsal evidence
- external assurance artifacts
- pilot KPI evidence
- consortium LOIs / MoU
