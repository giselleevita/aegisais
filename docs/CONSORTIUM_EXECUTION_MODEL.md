...
| ------------------------- | --------------------------------------------------- | --------------------- | --------------------- |
| Funding route matrix      | `docs/FUNDING_ROUTE_MATRIX.md`                      | Program Management    | Weekly                |
| Bid decision log          | `docs/FUNDING_ROUTE_MATRIX.md` (Bid-Go Log section) | CEO                   | Per decision          |
| Evidence pack             | `docs/SECURITY_EVIDENCE_PACK.md`                    | Security Engineering  | Per compliance change |
| Compliance control matrix | `docs/security/SECURITY_AND_COMPLIANCE.md`          | Security Engineering  | Monthly               |
| KPI baseline              | `docs/FUNDING_PILOT_EVIDENCE_TEMPLATE.md`           | Solutions Engineering | Per pilot             |
| This document             | `docs/CONSORTIUM_EXECUTION_MODEL.md`                | CEO + Partnerships    | Quarterly             |
