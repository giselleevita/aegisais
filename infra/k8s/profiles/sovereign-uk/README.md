# Sovereign UK Profile

Use this profile when workloads must remain aligned to UK residency and handling expectations.

## What This Profile Adds

- Annotates config for UK residency intent.
